...
import images from '../assets/images/corporativo.png';
import images2 from '../assets/images/inventarios.png';
import images3 from '../assets/images/aplicaciones.jpg';
import images4 from '../assets/images/dashboardAdmin.png';
import images5 from '../assets/images/reservas.png';
import images6 from '../assets/images/blog.png';
      ...
      <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 animate_animated animate_fadeInUp">
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images} className="card-img-top" alt="Proyecto Web Corporativo" />
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images2} className="card-img-top" alt="Sistema de Gestión Interna" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images3} className="card-img-top" alt="Aplicación Móvil Híbrida" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images4} className="card-img-top" alt="Dashboard Administrativo" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images5} className="card-img-top" alt="Sistema de Reservas" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card h-100 shadow-sm border-0">
            <img src={images6} className="card-img-top" alt="Blog Tecnológico" />
            <div className="card-body">
